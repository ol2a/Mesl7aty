...
<table class="customers">
  ...
  @foreach($craftman as $man)
  <tr>
    <td>{{$man->name}}</td>
    <td>{{$man->national-id}}</td>
    <td>{{$man->code}}</td>
    <td>{{$man->craft}}</td>
    <td>{{$man->phone}}</td>
    <td>{{$man->address}}</td>
    ...
    <td> 
        <a class="btn btn-denger" href="edit-crafst.html"><i class="fa-solid fa-pen-to-square"></i></a>
  ...
  <tr>
    ...
    <td>Carpenter</td>
    <td>0119873877</td>
    <td>16 korba street</td>
    
    <td> 
        <a class="btn btn-denger" href="ediit.html"><i class="fa-solid fa-pen-to-square"></i></a>
  ...
  <tr>
    ...
    <td>Paint</td>
    <td>0102567888</td>
    <td>26 Jule street</td>
    
    <td> 
        <a class="btn btn-denger" href=""><i class="fa-solid fa-pen-to-square"></i></a>
