...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('style9.css') }}">
  <!-- endinject -->
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('Craft.store') }}">
                    @csrf
                    <div class="form-group">
                      <label for="exampleFormControlInput1"></label> 
                      <input type="text" class="form-control" name="name"   value="" placeholder="Name"><br>
                      <input type="file" class="form-control" name="image"   value="" placeholder="image"><br>
...
<!-- <img src="{{ asset('images/GP1-removebg-preview.png') }}" alt="" class="logo"> -->
